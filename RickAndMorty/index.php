...
<head>
    ...
    <link rel="icon" href="Style/Recursos/Icon.png">
...
<body>
    <nav class="navbar navbar-expand-lg border border-dark ">
        <div class="container-fluid">
            <a href="index.html"><img src="Style/Recursos/RickAndMorty.svg" alt="Logo" width="150" style="margin-left: 30px;"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav " style="margin-left:30px;">
                    ...
                    <a class="nav text" href="#"><i class="fa-solid fa-play"></i> Episodios</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="container-fluid color text-center">
        <img src="Style/Recursos/Rick & Morty Gif.gif" height="300" alt="Img">
    ...
    <footer class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="col">
                <img src="Style/Recursos/RickAndMorty.svg" alt="Logo" width="150" style="margin-left: 30px;">
            </div>
